"""
run a pre-written Python script that employs AWS' Simple Queue Services (SQS) program.
The script is designed to create both a standard and a FIFO (First-In-First-Out) queue,
then dispatch, receive, and delete various messages within these queues.
Make sure to examine the script's structure and commands before executing
it for a better understanding of its procedures.
"""
